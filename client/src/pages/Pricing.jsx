...
const plans = [
  ...
  },
  {
    ...
    features: ['Unlimited exports', 'No watermark', '20 AI image credits/mo', 'Priority support'],
    cta: 'Start Starter',
    highlight: true,
  },
  {
    ...
    priceId: PRICES.pro,
    features: ['Everything in Starter', 'Batch project queue', 'SRT caption export', 'Priority rendering'],
    cta: 'Go Pro',
    highlight: false,
  },
];
