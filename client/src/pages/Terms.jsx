  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-8 py-16 w-full">
        ...
        <p className="text-muted text-sm mb-10">Agreement to Our Legal Terms</p>

        <p className="text-muted text-sm leading-relaxed">
          We are VoxFrame ("Company," "we," "us," "our"), a company registered in <strong className="text-white">[state/country]</strong>, United States at <strong className="text-white">[registered address]</strong>.
        </p>
        ...
        <p className="text-muted text-sm leading-relaxed mt-3">
          We are an automated editing tool for faceless YouTube creators with the goal of speeding up the syncing
          process of voiceovers and images.
        </p>
        <p className="text-muted text-sm leading-relaxed mt-3">
          You can contact us by email at{' '}
          <a href="mailto:only86177@gmail.com" className="text-accent hover:underline">only86177@gmail.com</a> or by
          mail to <strong className="text-white">[mailing address]</strong>, United States.
        </p>
        <p className="text-muted text-sm leading-relaxed mt-3">
          These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf
          of an entity ("you"), and VoxFrame, concerning your access to and use of the Services. You agree that by
        ...
        <p className="text-muted text-sm leading-relaxed mt-3">
          ...
          <a href="mailto:only86177@gmail.com" className="text-accent hover:underline">only86177@gmail.com</a>, as
        ...
        <ol className="text-accent text-sm leading-loose list-decimal list-inside">
          ...
          <li><a href="#representations" className="hover:underline">User Representations</a></li>
          <li><a href="#registration" className="hover:underline">User Registration</a></li>
          <li><a href="#payment" className="hover:underline">Purchases and Payment</a></li>
          ...
          <li><a href="#contributions" className="hover:underline">User Generated Contributions</a></li>
          <li><a href="#license" className="hover:underline">Contribution License</a></li>
          <li><a href="#management" className="hover:underline">Services Management</a></li>
          <li><a href="#privacy" className="hover:underline">Privacy Policy</a></li>
          <li><a href="#copyright" className="hover:underline">Copyright Infringements</a></li>
          <li><a href="#term" className="hover:underline">Term and Termination</a></li>
          ...
          <li><a href="#california" className="hover:underline">California Users and Residents</a></li>
        ...
        <Section id="ip" title="2. Intellectual Property Rights">
          <p><strong className="text-white">Our intellectual property</strong></p>
          <p>
          ...
          <p className="pt-2"><strong className="text-white">Your use of our Services</strong></p>
          <p>
          ...
          <p>
            ...
            <a href="mailto:only86177@gmail.com" className="text-accent hover:underline">only86177@gmail.com</a>. If
          ...
          <p className="pt-2"><strong className="text-white">Your submissions and contributions</strong></p>
          <p>
          ...
          <p>
            <strong className="text-white">Submissions:</strong> By directly sending us any question, comment,
            suggestion, idea, feedback, or other information about the Services ("Submissions"), you agree to assign
            to us all intellectual property rights in such Submission. You agree that we shall own this Submission
            and be entitled to its unrestricted use and dissemination for any lawful purpose, commercial or
            otherwise, without acknowledgment or compensation to you.
          </p>
          <p>
            <strong className="text-white">Contributions:</strong> The Services may invite you to chat, contribute
          ...
          <p>
            <strong className="text-white">When you post Contributions, you grant us a license</strong> (including
            ...
            and license to: use, copy, reproduce, distribute, sell, resell, publish, broadcast, retitle, store,
            publicly perform, publicly display, reformat, translate, excerpt (in whole or in part), and exploit your
            ...
            Contributions, and to sublicense the licenses granted in this section. Our use and distribution may occur
          ...
          <p>
            <strong className="text-white">You are responsible for what you post or upload:</strong> By sending us
          ...
          <p>
            <strong className="text-white">We may remove or edit your Content:</strong> Although we have no
            obligation to monitor any Contributions, we shall have the right to remove or edit any Contributions at
            any time without notice if in our reasonable opinion we consider such Contributions harmful or in breach
            of these Legal Terms. If we remove or edit any such Contributions, we may also suspend or disable your
            account and report you to the authorities.
          </p>

          <p className="pt-2"><strong className="text-white">Copyright infringement</strong></p>
          <p>
            ...
            <a href="#copyright" className="text-accent hover:underline">Copyright Infringements</a> section below.
          </p>
        </Section>
        ...
        <Section id="representations" title="3. User Representations">
          <p>
            ...
            or otherwise; (6) you will not use the Services for any illegal or unauthorized purpose; and (7) your use
        ...
        <Section id="payment" title="5. Purchases and Payment">
          ...
          <p>
            ...
            use the same billing address. We reserve the right to limit or prohibit orders that, in our sole
            judgment, appear to be placed by dealers, resellers, or distributors.
          </p>
        </Section>

        <Section id="subscriptions" title="6. Subscriptions">
          <p><strong className="text-white">Billing and Renewal</strong></p>
          <p>
            ...
            charge, until such time as you cancel the applicable order. The length of your billing cycle will depend
            on the type of subscription plan you choose when you subscribed to the Services.
          </p>
          <p className="pt-2"><strong className="text-white">Cancellation</strong></p>
          <p>
          ...
          <p className="pt-2"><strong className="text-white">Fee Changes</strong></p>
        ...
        <Section id="contributions" title="8. User Generated Contributions">
          <p>
        ...
        <Section id="management" title="10. Services Management">
          <p>
        ...
        <Section id="privacy" title="11. Privacy Policy">
          <p>
            ...
            <Link to="/privacy" className="text-accent hover:underline">Privacy Policy</Link> posted on the Services,
            which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United
        ...
        <Section id="disputes" title="16. Dispute Resolution">
          <p><strong className="text-white">Informal Negotiations</strong></p>
          <p>
            ...
            (except those Disputes expressly provided below) informally for at least ten (10) days before initiating
            arbitration. Such informal negotiations commence upon written notice from one Party to the other Party.
          </p>
          <p className="pt-2"><strong className="text-white">Binding Arbitration</strong></p>
          <p>
            ...
            governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. The
            ...
            the arbitration will take place in Brazoria County, Texas. Except as otherwise provided herein, the
          ...
          <p>
            ...
            prosecuted in the state and federal courts located in Brazoria County, Texas, and the Parties hereby
          ...
          <p>
            ...
            more than one (1) year after the cause of action arose. If this provision is found to be illegal or
          ...
          <p className="pt-2"><strong className="text-white">Restrictions</strong></p>
          <p>
          ...
          <p className="pt-2"><strong className="text-white">Exceptions to Informal Negotiations and Arbitration</strong></p>
          <p>
        ...
        <Section id="electronic" title="22. Electronic Communications, Transactions, and Signatures">
          <p>
            ...
            in any jurisdiction which require an original signature or delivery or retention of non-electronic
        ...
        <Section id="contact" title="25. Contact Us">
          ...
          <p className="pt-2">VoxFrame<br />United States<br /><a href="mailto:only86177@gmail.com" className="text-accent hover:underline">only86177@gmail.com</a></p>
        </Section>
      </main>
